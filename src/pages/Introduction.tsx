  ...
  return (
    <>
      ...
      <article className="doc-article">
        ...
        <Text as="p" size="3" mb="3">
          The scope runs from a solo designer formalizing conventions to a tech
          lead architecting a platform for dozens of product squads.
        </Text>
        ...
        <Text as="p" size="3" mb="5">
          ...
          organizations. Where there are genuine tradeoffs, the guide names them
          rather than pretending there's one right answer.
        </Text>
